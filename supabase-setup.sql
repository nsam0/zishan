...
-- 11. Trigger: Automatically Create Profile on Auth Signup / User Creation
...
BEGIN
  ...
  -- 4. Reassign authorized subjects
...
-- 13. RPC Function: Admin Deletes Teacher Account Completely
